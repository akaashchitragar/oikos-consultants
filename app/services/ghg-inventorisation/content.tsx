    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center">
        <div className="absolute inset-0">
          <Image
            src="/images/services/ghg-inventory.jpg"
            alt="GHG Inventorisation"
            fill
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-6">
              Comprehensive assessment and management of organizational GHG emissions for effective climate action
            </p>
            <Button
              size="lg"
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">
                  We assist organizations in identifying, quantifying, and reporting their GHG emissions through a systematic and thorough approach. Our expertise helps organizations understand their carbon footprint and develop effective strategies for emissions reduction.
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    description: "Defining boundaries and identifying emission sources within your organization",
                  ...
                  },
                  {
                    ...
                    description: "Gathering comprehensive data on all emission-generating activities",
                    bgColor: "bg-blue-50",
                    hoverBg: "hover:bg-blue-100",
                    iconColor: "text-blue-700"
                  },
                  {
                    icon: <Calculator className="h-8 w-8 text-teal-700" />,
                    title: "Emission Calculation",
                    description: "Applying proven methodologies to calculate total GHG emissions",
                    bgColor: "bg-teal-50",
                  ...
                  },
                  {
                    ...
                    description: "Ensuring accuracy and reliability of emission calculations",
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Emission Sources We Monitor
                </h3>
                <ul className="space-y-4">
                  {[
                    {
                      text: "Industrial Processes and Manufacturing",
                      icon: <Factory className="h-5 w-5 text-emerald-600 mt-1 mr-3 flex-shrink-0 transition-transform duration-300 hover:rotate-12" />
                    },
                    {
                      text: "Transportation and Fleet Operations",
                      icon: <Car className="h-5 w-5 text-emerald-600 mt-1 mr-3 flex-shrink-0 transition-transform duration-300 hover:rotate-12" />
                    },
                    {
                      text: "Waste Management Systems",
                      icon: <Recycle className="h-5 w-5 text-emerald-600 mt-1 mr-3 flex-shrink-0 transition-transform duration-300 hover:rotate-12" />
                    },
                    {
                    ...
                    },
                    {
                      ...
                      icon: <Truck className="h-5 w-5 text-emerald-600 mt-1 mr-3 flex-shrink-0 transition-transform duration-300 hover:rotate-12" />
                    },
                    {
                      text: "Production and Manufacturing",
                      icon: <Gauge className="h-5 w-5 text-emerald-600 mt-1 mr-3 flex-shrink-0 transition-transform duration-300 hover:rotate-12" />
                    }
                  ].map((item, index) => (
      ...
      <section className="relative py-24 bg-gradient-to-br from-[#2E7D32] to-[#1B5E20] text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-[0.07]">
            <BarChart3 className="absolute -top-12 -left-12 w-96 h-96 text-[#A8C6A1] transform rotate-12" />
            <PieChart className="absolute -bottom-12 -right-12 w-96 h-96 text-[#A8C6A1] transform -rotate-12" />
          </div>

          {/* Floating Elements - Left Side */}
          <div className="absolute left-0 inset-y-0 w-1/3">
            <Calculator className="absolute top-12 left-12 w-8 h-8 text-white opacity-20 animate-float-slow" />
            <LineChart className="absolute top-1/4 left-24 w-12 h-12 text-white opacity-15 animate-float-slow delay-200" />
            <Activity className="absolute top-1/2 left-16 w-10 h-10 text-white opacity-20 animate-float-slow delay-300 transform rotate-45" />
            <Gauge className="absolute bottom-1/4 left-20 w-6 h-6 text-white opacity-15 animate-float-slow delay-400" />
          </div>
          ...
          <div className="absolute left-1/3 right-1/3 inset-y-0">
            ...
            <Calculator className="absolute top-1/3 left-1/4 w-8 h-8 text-white opacity-15 animate-float-medium delay-150" />
            <LineChart className="absolute bottom-1/3 right-1/4 w-12 h-12 text-white opacity-20 animate-float-medium delay-300" />
          ...
          <div className="absolute right-0 inset-y-0 w-1/3">
            <PieChart className="absolute top-20 right-16 w-10 h-10 text-white opacity-20 animate-float-slow" />
            <BarChart3 className="absolute top-1/3 right-20 w-8 h-8 text-white opacity-15 animate-float-slow delay-150" />
            <Calculator className="absolute bottom-1/3 right-24 w-12 h-12 text-white opacity-20 animate-float-slow delay-300" />
            <LineChart className="absolute bottom-20 right-16 w-8 h-8 text-white opacity-15 animate-float-slow delay-450" />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-200 mb-8">
              Let&apos;s work together to understand and reduce your organization&apos;s GHG emissions. Schedule a consultation to discuss your inventorisation needs.
            </p>
            <Button
              size="lg"
