    ...
    <section className="relative py-24 bg-gradient-to-br from-[#2E7D32] to-[#1B5E20] text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute right-0 inset-y-0 w-1/3">
          <TreePine className="absolute top-20 right-16 w-10 h-10 text-white opacity-20 animate-float-fast" />
          <Flower2 className="absolute top-1/3 right-24 w-8 h-8 text-white opacity-15 animate-float-fast delay-150" />
          <Leaf className="absolute bottom-1/2 right-12 w-12 h-12 text-white opacity-20 animate-float-fast delay-300" />
          <Sprout className="absolute bottom-32 right-20 w-6 h-6 text-white opacity-15 animate-float-fast delay-450" />
        </div>

        {/* Additional Scattered Elements */}
        <div className="absolute inset-0">
          <motion.div 
            className="absolute top-1/4 left-1/2 w-3 h-3 bg-white rounded-full opacity-30"
            animate={{
              scale: [1, 1.5, 1],
          ...
          />
          <motion.div 
            className="absolute bottom-1/3 right-1/3 w-2 h-2 bg-white rounded-full opacity-20"
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.2, 0.1, 0.2],
            }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-sm border border-white/30 rounded-full hover:bg-white/15 transition-all duration-300">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#2E7D32] rounded-full font-semibold hover:bg-neutral-100 transition-all group shadow-lg hover:shadow-xl"
          >
